...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Sridhar Reddy Nalipi";
            $("#favicon").attr("href", "./assets/images/NSR_LOGO.png");
        }
        else {
...
var typed = new Typed(".typing-text", {
    strings: ["Final Year Student @ SIETK", "Froentend development", "Data Analyst", "Web Development", "Software Engineering","Mobile Photography"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
